...
[#elseif useragent?contains('MSIE') || (useragent?contains("Trident") && useragent?contains("rv:11") && useragent?contains("Windows"))]
<object id="factory" style="display:none"
		classid="clsid:1663ed61-23eb-11d2-b92f-008048fdd814"
		codebase="${base}/static/scripts/print/smsx.cab#Version=7,7,0,20"></object>
<script type="text/javascript" src="${base}/static/scripts/print/meadco-scriptx-1.1.0.min.js"></script>
